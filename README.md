...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-z4ew-v0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-z4ew-v0.containers.anotherwebservice.com/
...
```
git clone git@github.com:edangolgithub/container-z4ew-v0.git
cd container-z4ew-v0
```
...
```
docker attach container-z4ew-v0
```
